  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {genres.map((genre) => (
          <div key={genre.name} className="border rounded-lg overflow-hidden hover:shadow-xl transition">
            <Link href={`/genres/${encodeURIComponent(genre.name)}`} className="block">
              {/* ジャンル画像 */}
